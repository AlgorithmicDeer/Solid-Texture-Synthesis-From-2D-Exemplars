...
// Function for setting up the Vertex Array Object (VAO)
...
// Function for printing error logs
...
// Function for setting the GLSL version based on the platform
const char * setGLSLVersion(){
    // Set GLSL version based on the platform
    #if __APPLE__
    // GL 3.2 + GLSL 150
...
// Function for getting shader code from a file
...
// Function for setting up a GLFW window
GLFWwindow* setupWindow(int width, int height)
{
    ...
    GLFWwindow* window = glfwCreateWindow(width, height, "Solid Texture Synthesis from 2D Exemplars", NULL, NULL);
    if (window == NULL)
        exit(0);
...
// Function for computing the normalized vector between two vectors
